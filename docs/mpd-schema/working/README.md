...
This folder contains working implementations that the AI can copy.

Planned working docs (v1):
- User admin list with Typesense search
- User admin single record edit
