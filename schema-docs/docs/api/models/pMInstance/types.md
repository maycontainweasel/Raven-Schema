...
| `createdBy` | `string` | no | `""` |
| `instances` | `array<string>` | no | `"if (select value instance from only type::record(\"instance\", \"local\")) { return [select value instance from only type::record(\"instance\", \"local\")]; } else { return []; }"` |
## ID
- Export name: `PMInstanceId`
- Exported: yes
- Structure: `"key"`
## Notes
